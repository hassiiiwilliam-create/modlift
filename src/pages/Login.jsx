      ...
      >
        ...
        >
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="px-4 py-3 rounded-xl bg-coral-500/10 border border-coral-500/30 text-sm text-coral-400"
              >
                {error}
              </motion.div>
            )}
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link to="/signup" className="text-lime-400 hover:text-lime-300 font-medium transition-colors">
              Create one
            </Link>
          </p>
        </motion.div>
