-- ============================================================================
-- ModLift Products Seed Data (V2)
-- Compatible with existing schema using UUID ids
-- ============================================================================
...
INSERT INTO public.products (
  id, title, name, sku, category, brand, wheel_brand, wheel_model,
  wheel_diameter, wheel_width, wheel_offset, bolt_pattern,
...
(gen_random_uuid(), 'Fuel Rebel D680 20x9 Matte Black', 'Rebel D680', 'FUEL-D680-2090-6135-1', 'wheels', 'Fuel Off-Road', 'Fuel', 'Rebel D680',
  20, 9.0, 1, '6x135',
...
(gen_random_uuid(), 'Fuel Rebel D680 20x10 Bronze', 'Rebel D680', 'FUEL-D680-2010-6139-12', 'wheels', 'Fuel Off-Road', 'Fuel', 'Rebel D680',
  20, 10.0, -12, '6x139.7',
...
(gen_random_uuid(), 'Fuel Maverick D538 22x10 Black Milled', 'Maverick D538', 'FUEL-D538-2210-8170-44', 'wheels', 'Fuel Off-Road', 'Fuel', 'Maverick D538',
  22, 10.0, -44, '8x170',
...
(gen_random_uuid(), 'Fuel Triton D609 18x9 Gunmetal', 'Triton D609', 'FUEL-D609-1809-5150-12', 'wheels', 'Fuel Off-Road', 'Fuel', 'Triton D609',
  18, 9.0, -12, '5x150',
...
-- Method Race Wheels
(gen_random_uuid(), 'Method 305 NV 17x8.5 Matte Black', '305 NV', 'MRW-305-1785-6139-0', 'wheels', 'Method Race Wheels', 'Method', '305 NV',
  17, 8.5, 0, '6x139.7',
...
(gen_random_uuid(), 'Method 701 Trail 17x8.5 Bronze', '701 Trail', 'MRW-701-1785-5127-30', 'wheels', 'Method Race Wheels', 'Method', '701 Trail',
  17, 8.5, -30, '5x127',
...
(gen_random_uuid(), 'Method 312 20x9 Machined', '312', 'MRW-312-2009-6135-18', 'wheels', 'Method Race Wheels', 'Method', '312',
  20, 9.0, 18, '6x135',
...
-- KMC Wheels
(gen_random_uuid(), 'KMC XD820 Grenade 20x10 Satin Black', 'XD820 Grenade', 'KMC-XD820-2010-6139-24', 'wheels', 'KMC', 'KMC', 'XD820 Grenade',
  20, 10.0, -24, '6x139.7',
...
(gen_random_uuid(), 'KMC XD827 Rockstar III 18x9 Black', 'XD827 Rockstar III', 'KMC-XD827-1809-6120-12', 'wheels', 'KMC', 'KMC', 'XD827 Rockstar III',
  18, 9.0, -12, '6x120',
...
-- Vision Wheels
(gen_random_uuid(), 'Vision 361 Spyder 17x9 Matte Black', '361 Spyder', 'VIS-361-1709-5139-12', 'wheels', 'Vision', 'Vision', '361 Spyder',
  17, 9.0, -12, '5x139.7',
...
(gen_random_uuid(), 'Vision 399 Fury 20x9 Gloss Black', '399 Fury', 'VIS-399-2009-6135-12', 'wheels', 'Vision', 'Vision', '399 Fury',
  20, 9.0, -12, '6x135',
...
-- Moto Metal Wheels
(gen_random_uuid(), 'Moto Metal MO970 22x10 Black Milled', 'MO970', 'MM-MO970-2210-8165-18', 'wheels', 'Moto Metal', 'Moto Metal', 'MO970',
  22, 10.0, -18, '8x165.1',
...
(gen_random_uuid(), 'Moto Metal MO962 20x12 Chrome', 'MO962', 'MM-MO962-2012-6139-44', 'wheels', 'Moto Metal', 'Moto Metal', 'MO962',
  20, 12.0, -44, '6x139.7',
...
(gen_random_uuid(), 'American Force Blade SS8 22x12 Polished', 'Blade SS8', 'AF-BLADE-2212-8170-40', 'wheels', 'American Force', 'American Force', 'Blade SS8',
  22, 12.0, -40, '8x170',
...
INSERT INTO public.products (
  id, title, name, sku, category, brand, price, msrp, on_sale, free_shipping, in_stock, stock_quantity,
...
-- BFGoodrich
(gen_random_uuid(), 'BFGoodrich KO2 All-Terrain 285/70R17', 'KO2 All-Terrain', 'BFG-KO2-2857017', 'tires', 'BFGoodrich',
  289.00, 329.00, true, true, true, 40,
  '285/70R17', 285, 70, 17, 'all_terrain', 'BFGoodrich', 'KO2',
...
(gen_random_uuid(), 'BFGoodrich KO2 All-Terrain 35x12.50R20', 'KO2 All-Terrain', 'BFG-KO2-35125020', 'tires', 'BFGoodrich',
...
(gen_random_uuid(), 'BFGoodrich KO2 All-Terrain 315/70R17', 'KO2 All-Terrain', 'BFG-KO2-3157017', 'tires', 'BFGoodrich',
...
-- Nitto Tires
(gen_random_uuid(), 'Nitto Ridge Grappler 33x12.50R20', 'Ridge Grappler', 'NITTO-RG-33125020', 'tires', 'Nitto',
...
(gen_random_uuid(), 'Nitto Ridge Grappler 35x12.50R22', 'Ridge Grappler', 'NITTO-RG-35125022', 'tires', 'Nitto',
...
(gen_random_uuid(), 'Nitto Trail Grappler M/T 37x12.50R17', 'Trail Grappler', 'NITTO-TG-37125017', 'tires', 'Nitto',
...
-- Toyo Tires
(gen_random_uuid(), 'Toyo Open Country A/T III 265/70R17', 'Open Country A/T III', 'TOYO-ATIII-2657017', 'tires', 'Toyo',
...
(gen_random_uuid(), 'Toyo Open Country M/T 35x12.50R18', 'Open Country M/T', 'TOYO-MT-35125018', 'tires', 'Toyo',
...
-- Falken Tires
(gen_random_uuid(), 'Falken Wildpeak A/T3W 275/70R18', 'Wildpeak A/T3W', 'FALKEN-AT3W-2757018', 'tires', 'Falken',
...
-- Cooper Tires
(gen_random_uuid(), 'Cooper Discoverer STT Pro 35x12.50R17', 'Discoverer STT Pro', 'COOPER-STT-35125017', 'tires', 'Cooper',
...
-- Mickey Thompson
(gen_random_uuid(), 'Mickey Thompson Baja Boss A/T 33x12.50R20', 'Baja Boss A/T', 'MT-BAJAAT-33125020', 'tires', 'Mickey Thompson',
...
-- Rough Country
(gen_random_uuid(), 'Rough Country 6" Lift Kit RAM 1500', '6" Suspension Lift', 'RC-33430-RAM', 'suspension', 'Rough Country',
  1299.00, 1499.00, true, true, true, 8,
  'lift_kits', 6.0, 'Rough Country', 'full',
  true, true, true,
...
(gen_random_uuid(), 'Rough Country 4" Lift Kit Silverado', '4" Suspension Lift', 'RC-27531-SILV', 'suspension', 'Rough Country',
...
(gen_random_uuid(), 'Rough Country 2.5" Leveling Kit F-150', '2.5" Leveling Kit', 'RC-52230-F150', 'suspension', 'Rough Country',
...
-- BDS Suspension
(gen_random_uuid(), 'BDS 6" Suspension Lift F-250 Super Duty', '6" Suspension Lift', 'BDS-1527H-F250', 'suspension', 'BDS Suspension',
...
(gen_random_uuid(), 'BDS 4" Lift Kit Tacoma', '4" Suspension Lift', 'BDS-815H-TAC', 'suspension', 'BDS Suspension',
...
(gen_random_uuid(), 'Fox 2.5 Factory Race Series Coilovers Tacoma', '2.5 Factory Race Coilovers', 'FOX-883-02-121-TAC', 'suspension', 'Fox',
...
(gen_random_uuid(), 'Fox 2.0 Performance Series IFP Shocks F-150', '2.0 Performance IFP', 'FOX-985-24-185-F150', 'suspension', 'Fox',
...
(gen_random_uuid(), 'Icon Stage 2 Suspension System 4Runner', 'Stage 2 Suspension', 'ICON-K53172-4RUN', 'suspension', 'Icon Vehicle Dynamics',
...
-- Air Lift
(gen_random_uuid(), 'Air Lift LoadLifter 5000 RAM 1500', 'LoadLifter 5000', 'AIRLIFT-57275-RAM', 'suspension', 'Air Lift',
...
-- Belltech (Lowering)
(gen_random_uuid(), 'Belltech 2"/4" Lowering Kit Silverado', '2/4 Lowering Kit', 'BELL-1019SP-SILV', 'suspension', 'Belltech',
...
-- Skyjacker
(gen_random_uuid(), 'Skyjacker 3" Body Lift Jeep Wrangler JK', '3" Body Lift', 'SKY-JK30-BODY', 'suspension', 'Skyjacker',
...
(gen_random_uuid(), 'Warn VR EVO 10-S Winch', 'VR EVO 10-S', 'WARN-103253', 'accessories', 'Warn',
...
(gen_random_uuid(), 'Rigid Industries 50" E-Series LED Light Bar', 'E-Series 50" LED', 'RIGID-150313', 'accessories', 'Rigid Industries',
...
(gen_random_uuid(), 'Bushwacker Pocket Style Fender Flares F-150', 'Pocket Style Flares', 'BUSH-20945-02', 'accessories', 'Bushwacker',
...
(gen_random_uuid(), 'Fab Fours Vengeance Front Bumper RAM 1500', 'Vengeance Bumper', 'FABFOURS-DR19-V4952-1', 'accessories', 'Fab Fours',
...
INSERT INTO public.products (
  id, title, name, sku, category, brand, price, msrp, on_sale, free_shipping, in_stock, stock_quantity,
  wheel_diameter, wheel_width, wheel_offset, bolt_pattern, wheel_brand, wheel_model, wheel_finish,
  tire_size, tire_type, tire_brand, tire_model,
  is_combo, combo_savings,
  image_url, description, product_tags, vehicle_compatibility
) VALUES

(gen_random_uuid(), 'Fuel Rebel + BFG KO2 20" Combo', 'Rebel + KO2 Combo', 'COMBO-FUEL-BFG-20', 'combo', 'Fuel Off-Road',
...
(gen_random_uuid(), 'Method 305 + Nitto Ridge Grappler 17" Combo', 'Method 305 + Ridge Grappler', 'COMBO-METHOD-NITTO-17', 'combo', 'Method Race Wheels',
...
(gen_random_uuid(), 'KMC Grenade + Toyo Open Country 20" Combo', 'Grenade + Open Country', 'COMBO-KMC-TOYO-20', 'combo', 'KMC',
...
SELECT category, count(*) as product_count FROM public.products WHERE category IS NOT NULL GROUP BY category ORDER BY category;
